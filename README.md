...
COntext API removes the need for prop drilling, store data on a context object and retrieve that data in the necessary componnents from the context object, not props.
